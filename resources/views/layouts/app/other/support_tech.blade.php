<x-layouts::app.sidebar :title="$title ?? null" :back="true">
    <x-slot:navigation>
        <flux:sidebar.nav>
            ...
            <flux:navlist.item icon="cog-6-tooth" :href="route('settings.user.index')" wire:navigate>
                {{ __('Corps médicals') }}
            </flux:navlist.item>
            ...
            <flux:navlist.item icon="cog-6-tooth" :href="route('settings.projet.index')" wire:navigate>
